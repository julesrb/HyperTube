...
#
# Usage:
#   ./user_stories/scripts/demo_42_auth_story.sh
#
...
#
# Examples:
#   BASE_URL=http://localhost:8080 ./user_stories/scripts/demo_42_auth_story.sh
#   CURL_TIMEOUT=10 ./user_stories/scripts/demo_42_auth_story.sh
