...
export default function MoviesSmallCard({movie} : {movie: tmovies}) {
    return (
        <div className="relative w-48 h-72 overflow-hidden cursor-pointer group border rounded-sm">
            ...
            {/*<Image className="rounded-sm hover:border" width={100} height={100} src={"/images/" + film.src} alt={"poster of film: " + film.name}/>*/}
