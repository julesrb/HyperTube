...
export function UserIcon({ color = "black", size = 20 }) {
    const fullColor = `var(--color-${color})`;
...
export function SearchIcon({ color = "black", size = 20 }) {
    const fullColor = `var(--color-${color})`;
...
export function LanguageIcon({ color = "black", size = 20 }) {
    const fullColor = `var(--color-${color})`;

    return (<svg width={size} height={size} viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.5 0C16.6307 0 20.9752 3.36041 22.4561 8H22.625V8.58105C22.8689 9.51327 23 10.4913 23 11.5C23 12.5084 22.8688 13.486 22.625 14.418V15H22.4561C20.9752 19.6396 16.6307 23 11.5 23C11.4928 23 11.4857 22.999 11.4785 22.999C11.4753 22.999 11.472 23 11.4688 23C11.459 23 11.4492 22.9982 11.4395 22.998C5.11604 22.9654 0 17.8311 0 11.5C0 5.16892 5.11604 0.0335767 11.4395 0.000976562C11.4492 0.000870065 11.459 0 11.4688 0H11.5ZM7.24219 15C7.50202 16.6204 7.93315 18.0537 8.48145 19.2002C9.42504 21.1732 10.5347 21.9826 11.4424 21.998C11.4541 21.9981 11.4658 21.999 11.4775 21.999C12.3884 21.9939 13.5064 21.1859 14.4561 19.2002C15.0044 18.0537 15.4355 16.6204 15.6953 15H7.24219ZM16.709 15C16.266 17.9024 15.2856 20.3027 14.0137 21.6943C17.4575 20.8481 20.2321 18.3048 21.4004 15H16.709ZM1.59961 15C2.7588 18.2789 5.49884 20.8098 8.90527 21.6758C7.64197 20.2813 6.66947 17.889 6.22852 15H1.59961ZM1.30176 9C1.10598 9.80139 1 10.6383 1 11.5C1 12.3617 1.10598 13.1986 1.30176 14H6.10059C6.01524 13.1951 5.96875 12.3586 5.96875 11.5C5.96875 10.6414 6.01524 9.80491 6.10059 9H1.30176ZM7.10645 9C7.01773 9.79945 6.96875 10.6361 6.96875 11.5C6.96875 12.3639 7.01773 13.2006 7.10645 14H15.8311C15.9198 13.2006 15.9688 12.3639 15.9688 11.5C15.9688 10.6361 15.9198 9.79945 15.8311 9H7.10645ZM16.8369 9C16.9223 9.80491 16.9688 10.6414 16.9688 11.5C16.9688 12.3586 16.9223 13.1951 16.8369 14H21.6982C21.894 13.1986 22 12.3617 22 11.5C22 10.6383 21.894 9.80139 21.6982 9H16.8369ZM8.90527 1.32324C5.49873 2.18916 2.75882 4.721 1.59961 8H6.22852C6.66953 5.11067 7.64173 2.71769 8.90527 1.32324ZM11.4424 1.00098C10.5347 1.01639 9.42505 1.82682 8.48145 3.7998C7.93315 4.94631 7.50202 6.37956 7.24219 8H15.6953C15.4355 6.37956 15.0044 4.94631 14.4561 3.7998C13.5063 1.81406 12.3884 1.00517 11.4775 1C11.4658 1.00002 11.4541 1.00091 11.4424 1.00098ZM14.0137 1.30469C15.2858 2.69628 16.2659 5.09724 16.709 8H21.4004C20.232 4.69516 17.4576 2.15092 14.0137 1.30469Z" fill={fullColor}/>
        </svg>
...
export function ExitDoorIcon({ color = "black", size = 20 }) {
    const fullColor = `var(--color-${color})`;
