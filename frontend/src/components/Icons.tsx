...
export function HypertubeSmallLogo({ color = "black", height = 12 } : {color?: string, height?: number }) {
    const fullColor = `var(--color-${color})`;
    const width = height * 856 / 65;

    return (<svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 846 65" fill="none">
        <path d="M1.90735e-06 0H22.528V23.424H63.744V0H86.272V64H63.744V40.064H22.528V64H1.90735e-06V0ZM154.805 39.296V64H132.277V39.296L92.469 0H120.757L143.669 25.088L166.325 0H194.613L154.805 39.296ZM200.875 64V0H253.483C273.451 0 285.099 6.016 285.099 20.608C285.099 35.2 273.451 41.216 252.971 41.216H223.403V64H200.875ZM223.403 25.472H252.587C258.987 25.472 262.699 24.448 262.699 20.608C262.699 16.768 258.987 15.872 252.587 15.872H223.403V25.472ZM294.25 0H374.25V15.872H316.778V23.936H371.946V39.808H316.778V48.128H374.25V64H294.25V0ZM451.363 64C449.571 61.824 449.315 59.264 448.547 56.32L446.499 48.128C445.219 42.624 443.043 40.32 434.979 40.32H410.403V64H387.875V0H440.483C460.451 0 472.099 4.352 472.099 18.432C472.099 28.672 463.907 32.896 454.179 34.56C463.395 35.328 467.747 38.272 469.411 46.464L471.331 55.936C472.099 59.776 472.483 61.568 473.635 62.848V64H451.363ZM410.403 26.24H438.819C445.987 26.24 449.699 25.216 449.699 20.992C449.699 16.64 445.987 15.872 438.819 15.872H410.403V26.24ZM558.469 0V16.64H530.181V64H507.909V16.64H479.621V0H558.469ZM610.758 64.64C579.014 64.64 567.75 52.096 567.75 30.592V0H590.15V30.592C590.15 41.856 595.142 48.128 610.758 48.128C626.374 48.128 631.366 41.856 631.366 30.592V0H653.51V30.592C653.51 52.096 642.374 64.64 610.758 64.64ZM667 64V0H719.48C738.04 0 750.456 4.096 750.456 16.384C750.456 23.424 745.208 27.264 736.76 29.056C746.744 30.72 753.144 34.944 753.144 44.928C753.144 58.624 739.832 64 721.016 64H667ZM689.4 48.128H720.76C727.032 48.128 730.744 47.36 730.744 43.52C730.744 39.552 727.032 38.784 720.76 38.784H689.4V48.128ZM689.4 24.576H719.992C725.88 24.576 729.72 23.936 729.72 20.096C729.72 16.512 725.88 15.872 719.992 15.872H689.4V24.576ZM765.625 0H845.625V15.872H788.153V23.936H843.321V39.808H788.153V48.128H845.625V64H765.625V0Z" fill={fullColor}/>
    </svg>);
}
